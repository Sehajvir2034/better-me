          ...
          <div className="flex min-h-55 flex-col items-center justify-center rounded-2xl border border-dashed border-white/12 bg-[#1e2235]  px-6 py-10 text-center">
            ...
            <SmartProductDialog
              ...
              trigger={
                <button
                  type="button"
                  className="mt-5 inline-flex items-center gap-2 rounded-2xl  bg-teal-500/12 px-4 py-2.5 text-sm font-bold text-teal-300 transition-all hover:bg-teal-500/20 cursor-pointer"
                >
                  <Sparkles size={14} />
